...
//    }
    ...
    if ("POST".equals(request.getMethod())) {
        ...
        PreparedStatement ps = conn.prepareStatement("select * from post_user where username=? and user_password=?");
...
//            session.setAttribute("username", rs.getString("username"));
            response.sendRedirect("postdash.jsp");
    ...
    <div class="main-container_log">
        <div class="container-log">
            <div class="upper box-log">
                <h1>Login</h1>
                <h6>To access your user dashboard</h6>
            </div>
            <div class="lower box-log">
                <form action="" method="POST">
                    ...
                    <input type="submit" value="Login as user" name="login" class="login-btn">
                    <button type="" name="login" class="login-btn"><a href="adminlog.jsp" >Go to Admin Login</a></button>
